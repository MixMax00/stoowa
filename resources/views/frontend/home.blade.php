                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="main_slider" data-slick='{"arrows": false}'>
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('storage/banner/'.$banner->banner_image )}}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">{{ $banner->banner_title_top }}</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">{{ $banner->banner_title }}</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">{{ $banner->banner_description }}</p>
                                        <div class="item_price" data-animation="fadeInUp2" data-delay=".6s">
                                            <del>${{ $banner->price }}</del>
                                            <span class="sale_price">${{ $banner->sele_price }}</span>
                                        </div>
                                        <a class="btn btn_primary" href="{{ route('banner-details',['slug' =>$banner->slug,'id'=>$banner->id]) }}" data-animation="fadeInUp2" data-delay=".8s">Start Buying</a>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div class="best-selling-products">
                                ...
                                <div class="product-area clearfix">
                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="details">
                                            <h4><a href="{{ route('shop-details' ,['slug' =>$bestSell->slug,'id'=>$bestSell->id]) }}">Macbook Pro</a></h4>
                                            <p><a href="{{ route('shop-details',['slug' =>$bestSell->slug,'id'=>$bestSell->id]) }}">Apple MacBook Pro13.3″ Laptop with new Touch bar ID </a></p>
                                            <div class="rating">
                                            ...
                                            <div class="add-cart-area">
                                                <a href="{{ route('shop-details' ,['slug' =>$bestSell->slug,'id'=>$bestSell->id]) }}" class="add-to-cart">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
