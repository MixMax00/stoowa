                                           ...
                                           @forelse ($products as $product)
                                            <div class="grid">
                                                <div class="product-pic">
                                                   <a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}"> <img src="{{ asset('storage/product/'.$product->product_image) }}" alt="$products->product_title" /></a>
                                                    ...
                                                    <div class="actions">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a class="quickview_btn" data-bs-toggle="modal" href="#product-{{ $product->id}}" role="button" tabindex="0">
                                                                    <svg
                                                                        width="48px"
                                                                        height="48px"
                                                                        viewBox="0 0 24 24"
                                                ...
                                                <div class="details">
                                                    <h4><a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}">{{ $product->product_title }}</a></h4>
                                                    <p><a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}">{{ $product->short_description }}</a></p>
                                                    <div class="rating">
                                                    ...
                                                    <div class="add-cart-area">
                                                        ...
                                                        <a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}" class="add-to-cart btn btn-dark">Add to cart</a>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="product_details_content">
                                                                                ...
                                                                                <div class="quantity_wrap">
                                                                                    ...
                                                                                    <div class="total_price" data-total="{{ $product->sale_price }}">Total: ${{ $product->sale_price }}</div>
                                                                                </div>
...
@section('frontend_js')
    ...
    <script>
         $(document).ready(function(){
            ...
            $totalPrice = $('.total_price')[2].dataset.total;
             var num = 1;
