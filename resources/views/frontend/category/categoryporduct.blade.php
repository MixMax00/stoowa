                                        ...
                                        <div class="product-area shop-grid-product-area clearfix">
                                            ...
                                            <div class="grid">
                                                <div class="product-pic">
                                                    <a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}"><img src="{{ asset('storage/product/'.$product->product_image) }}" alt="$product->product_title" /></a>
                                                    <div class="actions">
                                                        <ul>
                                                            <li>
                                                                <a href="#">
                                                ...
                                                <div class="details">
                                                    ...
                                                    <span class="price">
                                                        <ins>
                                                            <span class="woocommerce-Price-amount amount">
                                                                ...
                                                                <del> <span class="woocommerce-Price-currencySymbol">$</span>{{ $product->price}}</del>
                                                                 @else
                                                    ...
                                                    <div class="add-cart-area">
                                                        <a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}">Add to cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                    ...
                                    <div class="product_layout2_wrap">
                                        <div class="product-area-row">
                                            ...
                                            <div class="grid clearfix">
                                                ...
                                                <div class="details">
                                                    <h4><a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}">{{ $product->product_title }}</a></h4>
                                                    <p class="w-50">{! $product->short_description !}</p>
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
                                                        <i class="fas fa-star"></i>
                                                        <i class="fas fa-star"></i>
                                                    ...
                                                    <div class="add-cart-area">
                                                        <a href="{{ route('shop-details' ,['slug' =>$product->slug,'id'=>$product->id]) }}" class="add-to-cart">Add to cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
