            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br>
                            <form method="POST" action="{{ route('color.store')}}" enctype="multipart/form-data" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                                @csrf
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-7 col-sm-6 ">
                                        <input type="text" id="first-name" name="color_name" required="required" class="form-control ">
                                    </div>
                                </div>
