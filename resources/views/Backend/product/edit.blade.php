            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br>
                            <form method="POST" action="{{ route('product.update', $product->id)}}" enctype="multipart/form-data" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 ">
                                                <input type="text" id="first-name" name="product_title" value="{{ $product->product_title }}" required="required" class="form-control ">
                                                @error('product_title')
                                    ...
                                    <div class="col-md-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-10 col-sm-6 ">
                                                <input type="text" id="first-name" name="quantity" value="{{ $product->quantity }}" required="required" class="form-control ">
                                                @error('quantity')
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6 offset-4">
                                                <img width="100" src="{{ asset('storage/product/'.$product->product_image) }}" alt="{{ $product->product_title }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6 offset-4">
                                                @foreach ($galleres as $gall)
                                                 <img width="50" src="{{ asset('storage/product-description/'.$gall->image) }}" alt="{{ $product->product_title }}">
                                                @endforeach
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-10 col-sm-6 ">
                                                <textarea id="first-name" name="short_description" class="form-control " rows="2">{{ $product->short_description }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-10 col-sm-6 ">
                                                <textarea id="first-name" name="description" class="form-control summernote" rows="10">{{ $product->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-10 col-sm-6 ">
                                                <textarea id="first-name" name="add_info" class="form-control summernote" rows="10">{{ $product->add_info }}</textarea>
                                            </div>
                                        </div>
                                    </div>
