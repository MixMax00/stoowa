            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br>
                            <form method="POST" action="{{ route('city.store')}}" enctype="multipart/form-data" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                                @csrf
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-5 col-sm-3 label-align" for="first-name">City Name<span class="required">*</span>
                                    </label>
                                    <div class="col-md-7 col-sm-6 ">
                                        <input type="text" id="first-name" name="city_name" required="required" class="form-control">
                                    </div>
                                </div>
